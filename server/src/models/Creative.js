...
creativeStrategySchema.index({ organizationId: 1 });
creativeStrategySchema.index({ organizationId: 1, projectId: 1 });
creativeStrategySchema.index({ organizationId: 1, createdBy: 1 });
