...
import { ArrowLeft, Plus, X, CheckCircle, Lightbulb, Eye } from 'lucide-react';
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-blue-700">
                You can view the Offer Engineering stage, but only Performance Marketers can make changes.
